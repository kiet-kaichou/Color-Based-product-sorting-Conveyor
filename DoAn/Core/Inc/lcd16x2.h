...
/** Includes ---------------------------------------------------------------- */
#include "stm32f1xx_hal.h"  // ✅ QUAN TRỌNG: Đổi từ stm32f10x sang stm32f1xx_hal
...
#define LCD16X2_DISPLAY_OFF_CURSOR_OFF_BLINK_OFF  \
    (LCD16X2_DISPLAY_OFF | LCD16X2_CURSOR_UNDERLINE_OFF | LCD16X2_CURSOR_BLINK_OFF)
#define LCD16X2_DISPLAY_ON_CURSOR_OFF_BLINK_OFF   \
    (LCD16X2_DISPLAY_ON | LCD16X2_CURSOR_UNDERLINE_OFF | LCD16X2_CURSOR_BLINK_OFF)
#define LCD16X2_DISPLAY_ON_CURSOR_OFF_BLINK_ON    \
    (LCD16X2_DISPLAY_ON | LCD16X2_CURSOR_UNDERLINE_OFF | LCD16X2_CURSOR_BLINK_ON)
#define LCD16X2_DISPLAY_ON_CURSOR_ON_BLINK_OFF    \
    (LCD16X2_DISPLAY_ON | LCD16X2_CURSOR_UNDERLINE_ON | LCD16X2_CURSOR_BLINK_OFF)
#define LCD16X2_DISPLAY_ON_CURSOR_ON_BLINK_ON     \
    (LCD16X2_DISPLAY_ON | LCD16X2_CURSOR_UNDERLINE_ON | LCD16X2_CURSOR_BLINK_ON)
